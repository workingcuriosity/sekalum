...
test('FacebookProvider validates OAuth callback code before service call', async () => {
...
test('FacebookProvider refresh requires Credential refreshToken', async () => {
  const provider = new FacebookProvider({
    oauthService: {
      refresh() {
...
test('FacebookProvider healthCheck requires Credential accessToken', async () => {
  const provider = new FacebookProvider({
    oauthService: {
      healthCheck() {
